      ...
      <nav className="fixed top-0 w-full bg-background/80 backdrop-blur-xl border-b border-cyan-500/20 z-50 animate-slide-up">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold shadow-lg shadow-cyan-500/50 hover:shadow-cyan-500/80 transition-all duration-300 transform hover:scale-105">
              Get Started
            </Button>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            ...
            <p className="text-lg text-foreground/70 font-medium">Simple, secure, and transparent</p>
          </div>

          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "1", title: "Register", desc: "Create account with email or decentralized ID" },
              { step: "2", title: "Encrypt", desc: "Messages encrypted with Kyber + AES-256" },
              { step: "3", title: "Send", desc: "Encrypted message delivered to recipient" },
              { step: "4", title: "Verify", desc: "Metadata logged on blockchain for audit trail" },
            ].map((item, idx) => (
              <div
                key={idx}
