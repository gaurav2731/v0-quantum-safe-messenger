...
import { Lock, Eye, EyeOff, AlertCircle, ArrowRight, UserPlus } from "lucide-react"
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}/api/auth/register`, {
        ...
        body: JSON.stringify({
          ...
          email,
          password,
          publicKey: 'demo-public-key-' + Date.now(), // In real app, generate PQC keys here
      ...
      <Card className="w-full max-w-md bg-slate-800/50 border-cyan-500/20">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate-400">
            Join the quantum-safe messaging network
          </CardDescription>
        </CardHeader>
